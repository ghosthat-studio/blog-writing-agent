"""Your agent's memory: a directory of JSON files. Inspectable, versionable, yours.

That is the entire technology, and it does not need a vector database. An agent
without memory is a chatbot on a cron job. This is what it remembers between
